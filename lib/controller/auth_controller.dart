...
import 'package:flutter_app/service/local_service/local_auth_service.dart';
import 'package:flutter_app/service/remote_service/remote_auth_service.dart';
...
class AuthController extends GetxController {
  ...
  void signUp(
    ...
    try {
      ...
      EasyLoading.showError('Something wrong. Try again! $e');
    } finally {
      EasyLoading.dismiss();
    }
  }
  ...
  void signIn({required String email, required String password}) async {
    try {
      ...
      if (result.statusCode == 200) {
        ...
        EasyLoading.showError('Username or password wrong. Try again!');
      }
    } catch (e) {
      EasyLoading.showError('Something wrong. Try again! $e');
    } finally {
